...
export class HistoricoMesasPage implements OnInit {
    ...
    constructor(public router: Router, public historicoService: HistoricoService, private pessoaService: PessoaService, private mesaService: MesaService) {
        // this.mesas = [
        //     {
        //         id: 0,
    ...
    ionViewWillEnter() {
      this.mesas = [];
        this.mesaService.getMesas().subscribe( (res) => {
          this.mesas = res;
